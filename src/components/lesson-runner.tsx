  ...
  return (
    <main className="flex flex-1 w-full flex-col px-4 pt-6 pb-10">
      <div className="mb-4 flex items-center justify-between">
        <Link href="/" className="text-base text-zinc-500 dark:text-zinc-400" aria-label="トップへ">
          ← トップ
        </Link>
      </div>
      ...
      <section className="mt-6 flex flex-col gap-3">
        <button
          ...
          className="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-5 text-left shadow-sm active:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:active:bg-zinc-800"
        >
          <span className="block text-lg font-semibold text-zinc-900 dark:text-zinc-100">暗記</span>
...
function PreviewPlayIcon() {
  return (
    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-zinc-950 text-white shadow-sm dark:bg-zinc-100 dark:text-zinc-950">
...
function MemorizeModePreview() {
  return (
    <span aria-hidden="true" className="mx-auto mt-4 block w-full max-w-sm">
      <span className="block rounded-xl bg-zinc-50 px-4 py-4 dark:bg-zinc-950">
        <span className="flex items-end justify-between gap-4">
          <span className="flex min-w-0 items-end gap-x-1">
            <span className="flex flex-col items-center">
              <span className="text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">nǐ</span>
              <span className="font-serif text-5xl leading-tight text-zinc-950 dark:text-zinc-100">
                你
              </span>
            </span>
            <span className="flex flex-col items-center">
              <span className="text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">hǎo</span>
              <span className="font-serif text-5xl leading-tight text-zinc-950 dark:text-zinc-100">
                好
              </span>
            </span>
        ...
        <span className="mt-3 block h-px bg-zinc-200 dark:bg-zinc-800" />
        <span className="mt-3 block text-base leading-relaxed text-zinc-800 dark:text-zinc-200">
          こんにちは！
        </span>
      </span>
    </span>
...
function QuizModePreview() {
  ...
  return (
    <span aria-hidden="true" className="mx-auto mt-4 block w-full max-w-sm">
      <span className="block rounded-xl bg-zinc-50 px-4 py-4 dark:bg-zinc-950">
        <span>
          <span className="block text-xl font-bold text-zinc-950 dark:text-zinc-100">
            ピンインを選ぶ
          </span>
        </span>
        <span className="mt-3 grid grid-cols-2 gap-2">
          {choices.map((option) => (
            <span
              key={option}
              className="flex h-10 items-center justify-center rounded-lg border border-zinc-200 bg-white text-lg font-semibold text-zinc-950 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100"
            >
              {option}
            </span>
          ))}
